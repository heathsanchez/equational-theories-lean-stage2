...
A one-edge contraction of the residual cut requires an equality with one
endpoint already in the lhs component and the other already in the rhs
component.  We also record one-sided attachment and subterm-level attachment.

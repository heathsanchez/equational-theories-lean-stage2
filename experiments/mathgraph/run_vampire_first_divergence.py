...
def main():
    ...
    student=[]
    for c in engine.search.clauses: student.append((inline_engine_names(c.lhs,engine.reverse_constants),inline_engine_names(c.rhs,engine.reverse_constants)))
